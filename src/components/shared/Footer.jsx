...
//   return (
//     <div className='py-30  '>
//     <footer className="border-t border-t-gray-00 text-left   ">
//       <div className="container mx-auto px-4">
//         <div className="flex flex-col md:flex-row justify-between items-center mt-8">
//           <div className="mb-4 md:mb-0">
//             <h2 className="text-3xl font-bold italic ">Hire hub</h2>

//         <br/>
//             <p className="text-sm italic">© 2025 Your Company. All rights reserved.</p>
//           </div>
...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-8 mt-45">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
        {/* About Section */}
        <div>
          <h2 className="text-2xl font-semibold mb-4">About Us</h2>
          <p className="text-gray-400">
            We connect job seekers with top companies to create a seamless
            hiring experience.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="text-gray-400 space-y-2">
            ...
            <li>
              <a href="/latestjob" className="hover:text-blue-400">
                Latest Companies
              </a>
            </li>
            <li>
